	  ...
	  <section id="half-n-half">
		<div class="container">
			<div id="laptop" class="position-relative">
				<img src="{{themes('site/img/laptop.png')}}" class="img-fluid">
				<video autoplay muted loop>
					<source src="{{themes('site/vid/laptop.mp4')}}" type="video/mp4">
	...
	<section id="" class="container pb-0">
		<div class="row">
			<div class="col-12 offset-md-3 col-md-6">
				...
				<div class="input-group">
					<input type="text" id="phone" name="phone" class="form-control" placeholder="Phone number" aria-label="Your phone number" aria-describedby="btn-enrol" value="{{old('phone')}}">
	  ...
	  <main id="main">
		...
		<section id="features" class="features pb-0">
		  <div class="container">
			...
			<div class="section-title">
			  ...
			  <img src="{{themes('site/img/reading.png')}}" class="img-fluid mt-4">
			</div>
			...
			<div class="row">
				...
				<div class="col-6 d-none d-md-block timeline-left">
					<img src="{{themes('site/img/content.png')}}" class="img-fluid" style="margin-top:-50px; max-height:340px;">
				</div>
				...
				<div class="col-12 text-center d-md-none">
					<img src="{{themes('site/img/content.png')}}" class="img-fluid my-3" style="max-height:200px;">
			...
			<div class="row">
				...
				<div class="col-6 d-none d-md-block timeline-right">
					<img src="{{themes('site/img/interactions.png')}}" class="img-fluid" style="margin-top:-50px; max-height:360px;">
				</div>
				<div class="col-12 text-center d-md-none">
					<img src="{{themes('site/img/interactions.png')}}" class="img-fluid my-3" style="max-height:200px;">
			...
			<div class="row">
				...
				<div class="col-6 d-none d-md-block timeline-left">
					<img src="{{themes('site/img/exam.png')}}" class="img-fluid" style="margin-top:-50px; max-height:340px;">
				</div>
				<div class="col-6 d-none d-md-block timeline-right">
				...
				<div class="col-12 text-center d-md-none">
					<img src="{{themes('site/img/exam.png')}}" class="img-fluid my-3" style="max-height:200px;">
			...
			<div class="row">
				...
				<div class="col-6 d-none d-md-block timeline-right">
					<img src="{{themes('site/img/assess.png')}}" class="img-fluid" style="margin-top:-50px; max-height:340px;">
				</div>
				<div class="col-12 text-center d-md-none">
					<img src="{{themes('site/img/assess.png')}}" class="img-fluid my-3" style="max-height:200px;">
			...
			<div class="row">
				<div class="col-12 focus text-center">
					...
					<img src="{{themes('site/img/win.png')}}" class="img-fluid d-block mx-auto mt-3" style="max-height:250px;">
				</div>
			</div>
		...
		<section id="screenshots" class="screenshots bg-navy">
			<div class="container">
				<div class="section-title">
					<img src="{{themes('site/img/en_badge_web_generic.png')}}" style="height:60px; width:auto;">
				...
				<div class="carousel slide carousel-fade mx-auto" style="max-width:300px;" data-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="{{themes('site/img/sc_home.png')}}" class="d-block w-100">
						</div>
						<div class="carousel-item">
							<img src="{{themes('site/img/sc_learn.png')}}" class="d-block w-100">
						</div>
						<div class="carousel-item">
							<img src="{{themes('site/img/sc_anim1.png')}}" class="d-block w-100">
						</div>
					</div>
				</div>
			</div>
