...
{!! Form::open(array('url' => URL_PAYNOW.$item->slug, 'method' => 'POST', 'id'=>'payform')) !!}
					...
					<input type="hidden" name="is_onlineclass_applied" id="is_onlineclass_applied"  value="1" >
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="ordered-item">
								<div class="col-md-6 centered">
									<div class="box">
									<span for="subscribe_onlineclasses">Subscribe for online classes</span>
									<!-- <input type="checkbox" name="subscribe_onlineclasses" id="subscribe_onlineclasses" value="{{$online_classes_price}}" data-toggle="toggle" data-onstyle="success" data-offstyle="default" checked> -->

									<input type="checkbox" style="display: block;" name="subscribe_onlineclasses" id="subscribe_onlineclasses" value="{{$online_classes_price}}" ng-model="subscribe_onlineclasses" ng-checked="isAppliedOnlineClass" ng-click="subscribeOnlineclass()">
								</div>
								</div>
								<div class="col-md-3  text-right">
									<strong>{{ getCurrencyCode().$online_classes_price }}</strong>
								</div>
								<div class="col-md-3  text-right">
									<strong>{{ getCurrencyCode().$online_classes_price }}</strong>
								</div>
...
<?php
								$cart_subtotal = $item->cost + $online_classes_price;
								?>
								...
								<div class="col-md-6 ">
									...
									<ul class="budget">
										...
										<li>
											...
											<p class="pull-right"><span contenteditable="false" ng-bind="cart_subtotal">{{$cart_subtotal}}</span></p>
										...
										<li class="order-total">
											...
											<span contenteditable="false" ng-bind="ngtotal">{{$cart_subtotal}}</span></p>
