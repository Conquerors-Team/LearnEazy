				...
				<div class="panel panel-custom col-lg-6 col-lg-offset-3">
					...
					@if ($record)
					 <?php $button_name = getPhrase('update'); ?>
						{{ Form::model($record,
						array('route' => ['users.set_permissions', $record->slug ],
						'method'=>'post',  'novalidate'=>'','name'=>'registrationForm','name'=>'formLanguage ')) }}
					<!-- @else
                 ...
                 <!--    @dd(record); -->
					...
					<fieldset class="form-group">
						...
						<?php
						$permissions = \App\Permission::where('default_for_faculty', 'yes')->get()->pluck('title', 'id')->toArray();
						?>
