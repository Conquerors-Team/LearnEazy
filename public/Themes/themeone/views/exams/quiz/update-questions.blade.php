			...
			<div class="container-fluid">
				...
				<div class="panel panel-custom" ng-init="initAngData({{$settings}});" >
					...
					<?php $button_name = getPhrase('create'); ?>
							...
							<select class='form-control' name="topic_id" id="topic_id" ng-model="topic_id" ng-change="getQuestions()">
							...
							?>
							{{Form::select('question_bank_type_id', $categries, null, ['class'=>'form-control', "id"=>"question_bank_type_id", 'ng-model' => 'question_bank_type_id', 'ng-change' => "getQuestions()"])}}
							</fieldset>

							<fieldset class="form-group col-md-6">
							{{ Form::label('questionbank_category_id', getphrase('category')) }} <span class="text-red">*</span>
							<?php
							$categries = \App\QuestionbankCategory::get()->pluck('category', 'id')->prepend(getPhrase('select'), '');
							?>
							{{Form::select('questionbank_category_id', $categries, null, ['class'=>'form-control', "id"=>"questionbank_category_id", 'ng-model' => 'questionbank_category_id', 'ng-change' => "getQuestions()"])}}
							</fieldset>
