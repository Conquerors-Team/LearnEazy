<div ng-if="question_type=='radio'">
    ...
    <fieldset class="form-group col-md-4" >
        ...
        <textarea name="options[]" id="option_@{{ $index }}" class="form-control ckeditor" placeholder="Option @{{ $index+1 }}" ng-model="answers[$index].option_value"  min="1"  required="true"></textarea>
...
<fieldset class="form-group" ng-if="total_answers > 0 ">
         ...
         <span class="text-red">*</span>
			...
			{{ Form::text('correct_answers',  null , $attributes = array('class'=>'form-control', 'name'=>'correct_answers', 'id'=>'correct_answers', 'placeholder' => '1',
                'min'=>'1',
