...
//dd( str_replace( '\r\n', '<br>', $settings ) );
				//$settings = str_replace(array("\n", "\r"), '', '{"total_answers":4,"total_correct_answers":1,"correct_answers":2,"question_type":"radio","answers":[{"option_value":"<p>.66<\/p>","optionl2_value":"","has_file":0,"file_name":""},{"option_value":"<p>0.06<\/p>","optionl2_value":"","has_file":0,"file_name":""},{"option_value":"<p>0.65<\/p>","optionl2_value":"","has_file":0,"file_name":""},{"option_value":"<p>0.69<\/p>","optionl2_value":"","has_file":0,"file_name":""}]}');
				//dd( $settings );
				?>
				<div class="panel panel-custom  col-lg-12" ng-init="initAngData('{{ $settings }}');"
				 ng-controller="questionsController">
					...
					@else
						{!! Form::open(array('url' => URL_QUESTIONBANK_ADD . '/' . $subject->slug, 'method' => 'POST', 'files' => TRUE, 'name'=>'formQuestionBank ', 'novalidate'=>'', 'class'=>'validation-align')) !!}
					@endif

					 @include('exams.questionbank.form_elements',
					 array('button_name'=> $button_name),
					 array('topics' => $topics, 'subject' => $subject, 'record'=>$record, 'chapters' => $chapters))
