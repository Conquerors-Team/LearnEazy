...
@section('footer_scripts')
 ...
 @include('common.datatables', array('route'=> 'exams.questionbank.getList', 'search_columns' => ['subject' => request('subject_id'),'chapter' => request('chapter_id'),'topic' => request('topic_id'),'sub_topic' => request('sub_topic_id'), 'institute' => request('institute_id')]))
