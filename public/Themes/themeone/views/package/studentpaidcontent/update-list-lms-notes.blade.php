...
<fieldset class="form-group">
	{{ Form::label('lmsnotes', getphrase('lmsnotes')) }}
	<span class="text-red">*</span>
	{{Form::select('lmsnotes[]', $lmsnotes, null, ['class'=>'form-control select2', 'name'=>'lmsnotes[]', 'id' => 'lmsnotes', 'required' => 'true', 'multiple'=>'true',])}}
</fieldset>
