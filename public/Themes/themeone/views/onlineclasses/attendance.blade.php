				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						<div class="pull-right messages-buttons">
							...
							<a href="{{route('class.absent', ['slug' => $onlinecalss->slug])}}" class="btn  btn-primary button" >{{ getPhrase('absents')}}</a>
						</div>
						<h1>{{ $title }}</h1>
					</div>
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('route'=> route('class.attendence.list', ['slug' => $onlinecalss->slug]), 'route_as_url' => 'TRUE'))
