...
function classChanged()
{
  ...
  route = '{{url("mastersettings/class/get-batch")}}/' + class_id;
...
function facultyChanged()
{
  ...
  route = '{{url("mastersettings/class/get-user")}}/' + created_by_id;
...
{
  created_by_id = $('#created_by_id').val();
  route = '{{url("mastersettings/class/get-faculty-subjects")}}/' + created_by_id;
...
function batchChanged()
{
  ...
  route = '{{url("mastersettings/class/get-faculty")}}/' + batch_id;
...
function getChapterLMS()
{
  ...
  route = '{{url("online-classes/get-lms")}}/'+subject_id + '/' + chapter_id;
  var token = $('[name="_token"]').val();
  data= {_method: 'get', '_token':token};
  $.ajax({
    url:route,
...
function getChapterNotes()
{
  subject_id = $('#subject_id').val();
  chapter_id = $('#chapter_id').val();
  route = '{{url("online-classes/get-notes")}}/'+subject_id + '/' + chapter_id;
  var token = $('[name="_token"]').val();
  data= {_method: 'get', '_token':token};
  $.ajax({
    url:route,
