@include('emails.template_header')
 ...
 <div class="row">
    <div class="col-lg-12" style="margin:65px 0px;">
	  <h5 class="text-center" style="font-size:20px;font-weight:600;">Institute Registration was successfull</h5>
	</div>
  </div>
   ...
   <div class="row">
	...
	<p style="font-size:20px;margin:11px 0;">Thank you for you registrating your institute {{$institute_name}} with OES.</p>
