@include('emails.template_header')
 ...
 <div class="row">
   ...
   <div class="row">
    ...
    <p style="font-size:20px;margin:11px 0;">Our team will get back to you soon.</p>


<br>
    <p style="font-size:20px;margin:11px 0;">Once your account is activated, you will recieve a confirmation mail from our team, After which you may proceed to login with the below details</p>
