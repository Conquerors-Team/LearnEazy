			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav side-nav {{$block_class}}">
					...
					<ul id="lms" class="collapse sidemenu-dropdown">
							...
							<li><a href="{{ route('studentlms.subjects') }}"> <i class="fa fa-random"></i>{{ getPhrase('subjects') }}</a></li>
							<li><a href="{{ URL_STUDENT_LMS_SERIES }}"> <i class="fa fa-list-ol"></i>LMS</a></li>
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: 'couses',
      data: [12, 19, 3, 17, 28,4, 7],
      backgroundColor: "rgba(95,123,251,1)"
    }, {
      label: 'students',
      data: [30, 29, 5, 5, 20, 3, 10],
      backgroundColor: "rgba(255,93,110,1)"
    }]
  }
});
</script>
