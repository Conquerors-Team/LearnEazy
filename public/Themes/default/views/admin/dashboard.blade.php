				 ...
				 <div class="row">
					...
					<div class="col-md-3">
						<div class="card card-red text-xs-center">
							<div class="card-block">
								...
								<p class="card-text">{{ getPhrase('institutes')}}</p>
							</div>
							<a class="card-footer text-muted" href="{{URL_VIEW_INSTITUES}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="card card-blue text-xs-center">
							<div class="card-block">
								<h4 class="card-title">{{ App\Batch::get()->count()}}</h4>
								<p class="card-text">{{ getPhrase('institute_batches')}}</p>
							</div>
