...
<html lang="en">
	...
	<head>
		...
		<!-- Favicons -->
		<link href="<?php echo e(themes('site/img/favicon.png')); ?>" rel="icon">
		<link href="<?php echo e(themes('site/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">

		<!-- Google Fonts -->
		<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i" rel="stylesheet">

		<!-- Vendor CSS Files -->
		<link href="<?php echo e(themes('site/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(themes('site/vendor/icofont/icofont.min.css')); ?>" rel="stylesheet">

		<!-- Template Main CSS File -->
		<link href="<?php echo e(themes('site/css/home.css')); ?>" rel="stylesheet">

		<?php if(Request::routeIs('site.pricing') || Request::routeIs('site.institute') ): ?>
		<link rel="stylesheet" href="<?php echo e(themes('site/css/style.css')); ?>">
		<?php endif; ?>

		<link rel="manifest" href="public/manifest.json" />

		<?php if(Request::routeIs('user.login') || Request::routeIs('user.register') || Request::routeIs('user-otp.register')): ?>
	...
	<body>
		...
		<header id="header" class="fixed-top ">
			<div class="container d-flex align-items-center">
				<img src="<?php echo e(themes('site/img/logo.gif')); ?>" style="height:40px; width: auto;">
				<h1 class="logo pl-2 mr-auto">
					<?php if(Request::routeIs('site.home')): ?>
					<a href="#hero">Learn<span>Eazy</span></a>
					<?php else: ?>
					<a href="<?php echo e(route('site.home')); ?>">Learn<span>Eazy</span></a>
					<?php endif; ?>
					...
					<ul>
						...
						<li class="drop-down"><a href="#">Study Materials</a>
							<ul>
								...
								?>
								<li><a href="<?php echo e(route('site.board', ['board_id' => $board->slug])); ?>"><?php echo e($board->title); ?></a></li>
								<?php } ?>
								<li><a href="<?php echo e(route('site.ref_books')); ?>">Reference Books</a></li>
							</ul>
						</li>
						...
						<?php else: ?>
						<li class="btn btn-le-outline-dark"><a href="<?php echo e(route('site.institute')); ?>">Institute</a></li>
						<?php endif; ?>
						...
						<div class="col-lg-4 col-md-6 footer-links">
							<div class="row">
								<div class="col-6">
									<h4>Quick Links</h4>
									<ul>
										<!-- <li><i class="icofont-rounded-right"></i> <a href="<?php echo e(route('site.pricing')); ?>">Pricing</a></li> -->
										<li><i class="icofont-rounded-right"></i> <a href="<?php echo e(route('site.contact')); ?>">Contact Us</a></li>
										<li><i class="icofont-rounded-right"></i> <a href="<?php echo e(route('site.terms_of_service')); ?>">Terms of service</a></li>
										<li><i class="icofont-rounded-right"></i> <a href="<?php echo e(route('site.privacy_policy')); ?>">Privacy policy</a></li>
									</ul>
								</div>
								<div class="col-6">
									...
									<ul>
										...
										<li><i class="icofont-rounded-right"></i> <a href="<?php echo e(route('site.board', ['board_id' => $board->slug])); ?>"><?php echo e($board->title); ?></a></li>
										<?php } ?>
										<li><i class="icofont-rounded-right"></i> <a href="<?php echo e(route('site.ref_books')); ?>">Reference Books</a></li>
									</ul>
								</div>
							</div>
						</div>
		...
		<!-- Vendor JS Files -->
		<script src="<?php echo e(themes('site/vendor/jquery/jquery.min.js')); ?>"></script>
		<script src="<?php echo e(themes('site/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
		<script src="<?php echo e(themes('site/vendor/jquery.easing/jquery.easing.min.js')); ?>"></script>
		<script src="<?php echo e(themes('site/vendor/php-email-form/validate.js')); ?>"></script>
		<script src="<?php echo e(themes('site/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>

		<!-- Template Main JS File -->
		<script src="<?php echo e(themes('site/js/home.js')); ?>"></script>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<!-- <form> -->
							...
							<?php else: ?>
							<a class="text-orange" href="<?php echo e(route('user-otp.register')); ?>">SIGN UP FOR A NEW ACCOUNT</a>
							<?php endif; ?>
...
<script type="text/javascript">
   $('#loginForm').submit(function( e ) {
            ...
            if (error > 0) {
              ...
              //console.log(target)
              $.ajax({
                  url: '<?php echo e(URL_USERS_LOGIN); ?>',
                  type:'POST',
                          ...
                          //console.log(data.success);
                           if ( $('#redirect_url').val() != '') {
                            window.location = $('#redirect_url').val();
                             ...
                             window.location = '<?php echo e(URL_HOME); ?>';
                          }
   ...
   $('#registrationForm').submit(function( e ) {
            ...
            var image = "<?php echo e(themes('images/loader.svg')); ?>";
            ...
            if (error > 0) {
              ...
              $.ajax({
                  url: "<?php echo e(URL_USERS_REGISTER); ?>",
                  type:'POST',
                  ...
                  success: function(data) {
                      if($.isEmptyObject(data.error)){
                        ...
                        //displayMessage();
                        window.location = '<?php echo e(URL_USERS_DASHBOARD); ?>';
                      }else{
                          $('#loading').html("").hide();
