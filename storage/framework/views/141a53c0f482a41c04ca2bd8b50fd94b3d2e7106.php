					...
					<div class="row">
 					 <?php if($exam_type == 'test_series'): ?>
					<fieldset class="form-group col-md-3">
						<?php echo e(Form::label('display_type', getphrase('display_type'))); ?>
						...
						?>
						<?php echo e(Form::select('display_type', $display_types, null, ['class'=>'form-control','ng-model'=>'display_type'])); ?>
					...
					<fieldset class="form-group col-md-3" ng-if="display_type == 'subject' || display_type == 'chapter'">
							...
							?>
							<?php echo e(Form::select('subject_id', $subjects, null, ['class'=>'form-control','ng-model'=>'subject_id', 'id' => 'subject_id', 'onChange' => 'getSubjectChapters()'])); ?>
					...
					<fieldset class="form-group col-md-3" ng-if="display_type == 'chapter'">
							...
							?>
							<?php echo e(Form::select('chapter_id', $chapters, null, ['class'=>'form-control','ng-model'=>'chapter_id', 'id' => 'chapter_id'])); ?>

					</fieldset>

					<fieldset class="form-group col-md-3" ng-if="display_type == 'previousyear'">
					<?php echo e(Form::label('year', getphrase('year'))); ?>
					...
					?>
					<?php echo e(Form::select('year', $years, null, ['class'=>'form-control', "id"=>"year", "ng-model" => "year"])); ?>

					</fieldset>

					<fieldset class="form-group col-md-3" ng-if="display_type == 'previousyear' || display_type == 'grand'">
							<?php echo e(Form::label('chapter_id', getphrase('competitive_type'))); ?>
							...
							?>
							<?php echo e(Form::select('competitive_exam_type_id', $competitive_types, null, ['class'=>'form-control','ng-model'=>'chapter_id', 'id' => 'competitive_exam_type_id'])); ?>
				...
				<div class="row">
					...
					<fieldset class="form-group col-md-3">
							<?php echo e(Form::label('marks_per_question', getphrase('marks_per_question'))); ?>

							<span class="text-red">*</span>
							<?php echo e(Form::number('marks_per_question', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => getPhrase('enter_value_in_minutes'),
							'min'=>0,
			...
			<fieldset class="form-group col-md-4">
 			 ...
 			 <fieldset class="form-group col-md-4">
						...
						<?php echo e(Form::label('start_time', getphrase('start_time'))); ?>


						<?php echo e(Form::select('start_time', $slots_times, null, ['class'=>'form-control','placeholder'=>'select',
						    'ng-model'=>'start_time',
                   ...
                   <div class="row">
					...
					<?php $language_options = array('0'=>'No', '1'=>'Yes', );?>
					 ...
					 <fieldset class="form-group col-md-6" style="display: none;">
						...
						<span class="text-red">*</span>
						<?php echo e(Form::select('has_language', $language_options, null, ['class'=>'form-control',
