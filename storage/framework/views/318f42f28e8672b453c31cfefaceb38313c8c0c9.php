...
<div id="page-wrapper">
			...
			<div class="row">
				 	...
				 	<div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			<div class="media-left">
				 				<a href="<?php echo e(URL_BATCHS); ?>"><div class="state-icn bg-icon-blue"><i class="fa fa-sitemap"></i></div></a>
				 			</div>
				 			<div class="media-body">
				 				<h4 class="card-title">
				 						<?php echo e(Auth::user()->faculty_batches()->count()); ?>

				 					</h4>
								<a href="<?php echo e(URL_BATCHS); ?>"><?php echo e(getPhrase('institute_batches')); ?></a>
				 			</div>
				 		</div>
				 	</div>
				...
				<div class="col-md-12 col-sm-12 state-media box-ws">
			 		<h4 class="card-title1">Content Library</h4><a class="moreBtn" href="<?php echo e(URL_LMS_GROUPS); ?>">View all</a>
			 		<?php
			 		$faculty_subjects = \App\User::find( \Auth::id() )->subjects()->pluck('subject_id')->toArray();
			 		...
			 		<table class="table">
			 			...
			 			<?php $__empty_1 = true; $__currentLoopData = $lmsgroups->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
			 			<tr>
			 				<td><?php echo e($row->title); ?></td>
			 				<td>
			 					<a href="<?php echo e(route('lms-groups.show', ['slug' => $row->slug])); ?>" class="btn btn-lg btn-success button"><?php echo e(\DB::table('lmsseries_lmsgroups')->where('lmsgroups_id', $row->id)->count()); ?></a>
			 				</td>
			 			</tr>
			 	...
			 	<div class="col-md-12 col-sm-12 state-media box-ws">
			 		...
			 		<table class="table">
			 			...
			 			<?php $__empty_1 = true; $__currentLoopData = $onlineclasses->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
			 			<tr>
			 				<td><?php echo e(date('h:i A', strtotime($row->class_time))); ?></td>
			 				<td><?php echo e($row->batch->name); ?></td>
			 				<td><?php echo e($row->student_class->name); ?></td>
			 				<td><?php echo e($row->title); ?></td>
			 				<td>
			 					<?php
			 					...
			 					?>
			 					<?php if( $row->class_time < date('H:i:s', strtotime("-$class_duration minutes", strtotime(date('H:i:s'))) ) ): ?>
			 					<a href="javascript:void(0)" class="btn btn-lg btn-success button" disabled>Start</a>
			 					<?php else: ?>
			 					<a href="<?php echo e($row->url); ?>" target="_blank" class="btn btn-lg btn-success button">Start</a>
			 					<?php endif; ?>
			 				</td>
			 				<td>
			 					<?php if($row->lmsseries_id): ?>
			 					<a href="<?php echo e(URL_STUDENT_LMS_SERIES_VIEW.$row->lmsseries->slug); ?>" target="_blank"><?php echo e($row->lmsseries->title); ?></a><p><a style="color:red;" href="<?php echo e(route('onlineclass.lmsnotes', ['slug' => $row->slug])); ?>">Edit</a></p>
			 					<?php else: ?>
			 					<a style="color:red;" href="<?php echo e(route('onlineclass.lmsnotes', ['slug' => $row->slug])); ?>">Assign</a>
			 					<?php endif; ?>
			 				</td>
			 				<td>
			 					<?php if($row->lmsnotes_id): ?>
			 					<a href="<?php echo e(route('lms.preview_notes', ['slug' => $row->lmsnotes->slug])); ?>" target="_blank"><?php echo e($row->lmsnotes->title); ?></a><p><a style="color:red;" href="<?php echo e(route('onlineclass.lmsnotes', ['slug' => $row->slug])); ?>">Edit</a></p>
			 					<?php else: ?>
			 					<a style="color:red;" href="<?php echo e(route('onlineclass.lmsnotes', ['slug' => $row->slug])); ?>">Assign</a>
			 					<?php endif; ?>
			 				</td>
			 				<td>
			 					<?php if($row->live_quiz_id): ?>
			 					<a href="<?php echo e(URL_QUIZ_EDIT . '/' . $row->live_quiz->slug); ?>" target="_blank"><?php echo e($row->live_quiz->title); ?></a>
			 					...
			 					?>
			 					<a href="<?php echo e(route('live-quiz.unpop', ['online_class_id' => $row->id])); ?>" class="btn btn-lg btn-success button"><?php echo e($title); ?></a>
			 					<p><a style="color:red;" href="<?php echo e(route('onlineclass.lmsnotes', ['slug' => $row->slug])); ?>">Edit</a></p>
			 					<?php else: ?>
			 					<a style="color:red;" href="<?php echo e(route('onlineclass.lmsnotes', ['slug' => $row->slug])); ?>">Assign</a>
			 					<?php endif; ?>
			 				</td>
				 	...
				 	<div class="col-md-6 col-sm-6 state-media box-ws">
				 		<h4 class="card-title1">Batch Reports</h4><a class="moreBtn" href="<?php echo e(route('batch.reports')); ?>">View all</a>
				 		<?php
						...
						->orderBy('qr.created_at', 'desc')->limit(5)->get();
				 		...
				 		<table class="table">
				 			...
				 			<tr>
				 				...
				 				<td><?php echo e($row->title); ?></td>
				 				<td><a href="<?php echo e(url('batches/report/' . $row->id . '/' . $row->slug)); ?>" class="btn btn-lg btn-success button">View</a></td>
				 			</tr>
				 			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
				 	...
				 	<div class="col-md-6 col-sm-6 state-media box-ws">
				 		<h4 class="card-title1">Attendance</h4><a class="moreBtn" href="<?php echo e(route('onlineclasses.attendence')); ?>">View all</a>
				 		<?php
				 		$batches = Auth::user()->faculty_batches()->get()->pluck('id')->toArray();
        				...
        				->limit(7);
				 		...
				 		<table class="table1 table-responsive" style="margin:20px;">
				 			...
				 			<?php $__empty_1 = true; $__currentLoopData = $records->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				 			<tr>
				 				<?php
			 					$date = \App\OnlineclassAttendance::where('class_id', $row->id)->groupBy('student_id')->first();
			 					// dd($date);
			 					?>
				 				<td><?php echo e(date('d-m-Y', strtotime($date->created_at))); ?></td>
				 				<td><?php echo e(date('h:i A', strtotime($row->class_time))); ?></td>
				 				<td><?php echo e($row->name); ?></td>
				 				<td><?php echo e($row->title); ?></td>
				 				...
				 				<td>
				 					...
				 					?>
				 					<a href="<?php echo e(route('class.attendence', ['slug' => $row->slug])); ?>" class="btn btn-lg btn-success button"><?php echo e($count); ?></a>
				 				</td>
				 					<?php /*?>
				 					<td>
				 		<?php
        ...
        ?>
				 ...
				 <div class="row">
				  ...
				  <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			<div class="media-left">
				 				<a href="<?php echo e(URL_VIEW_INSTITUES); ?>"><div class="state-icn bg-icon-pink"><i class="fa fa-bank"></i></div></a>
				 			</div>
				 			<div class="media-body">
				 				<h4 class="card-title"><?php echo e(App\Institute::get()->count()); ?></h4>
								<a href="<?php echo e(URL_VIEW_INSTITUES); ?>"><?php echo e(getPhrase('institutes')); ?></a>
				 			</div>
				 		</div>
				 	</div>
				 	<?php endif; ?>
				 	...
				 	<div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title">
				 						<?php echo e(App\Batch::where('institute_id', $institute_id)->get()->count()); ?>
				 	...
				 	<div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title">
				 					<?php if( checkRole(getUserGrade(1)) ): ?>
				 					<?php echo e(App\User::where('role_id','!=',7)->get()->count()); ?>

				 					<?php else: ?>
				 					<?php echo e(App\User::where('role_id','!=',7)->where('institute_id', adminInstituteId())->get()->count()); ?>
				 	...
				 	<div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title">
				 					<?php echo e(App\Quiz::where('institute_id', $institute_id)->get()->count()); ?>

				 					</h4>
								<a href="<?php echo e(URL_QUIZZES); ?>"><?php echo e(getPhrase('exams')); ?></a>
				 			</div>
				 		</div>
				 	</div>
				 <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title">
				 					<?php if( checkRole(getUserGrade(1)) ): ?>
				 						<?php echo e(App\Subject::where('institute_id', $institute_id)->get()->count()); ?>

				 					<?php elseif(shareData('share_subjects')): ?>
				 					<?php echo e(App\Subject::whereIn('institute_id',[$institute_id, OWNER_INSTITUTE_ID])->get()->count()); ?>

				 					<?php else: ?>
				 					<?php echo e(App\Subject::where('institute_id', adminInstituteId())->get()->count()); ?>
				 	 ...
				 	 <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title">
				 					<?php if(shareData('share_topics')): ?>
				 					<?php echo e(App\Topic::whereIn('institute_id', [$institute_id, OWNER_INSTITUTE_ID])->get()->count()); ?>

				 					<?php else: ?>
				 					<?php echo e(App\Topic::where('institute_id', adminInstituteId())->get()->count()); ?>
				 	 ...
				 	 <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title">
				 					<?php if(shareData('share_questions')): ?>
				 						<?php echo e(App\QuestionBank::whereIn('institute_id', [$institute_id, OWNER_INSTITUTE_ID])->get()->count()); ?>

				 					<?php else: ?>
				 						<?php echo e(App\QuestionBank::where('institute_id', $institute_id)->get()->count()); ?>
