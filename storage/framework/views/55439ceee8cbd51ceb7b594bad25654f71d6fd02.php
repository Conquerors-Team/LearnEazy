            ...
            <div class="row align-items-sm-center align-items-lg-stretch">
                <div class="col-md-7 col-lg-7">
                    <div class="learning_img">
                        <img src="<?php echo e(themes('site/img/learning_img.png')); ?>" alt="">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><img src="<?php echo e(themes('site/img/3.png')); ?>" class="ani-img"></span>
                            <h4>Live Classes</h4>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><img src="<?php echo e(themes('site/img/2.png')); ?>" class="ani-img"></span>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><img src="<?php echo e(themes('site/img/3.png')); ?>" class="ani-img"></i></span>
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-4">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            <span class="single_feature_icon"><img src="<?php echo e(themes('site/img/4.png')); ?>" class="ani-img"></span>
