	...
	<div class="col-md-9">
		<div class="leftSideContent">
			...
			<div class="col-md-12 welcomeText">
				<div class="">
					<div class="col-md-9">
						<h4> Welcome back ! <?php echo e($user->name); ?></h4>
						<p>
							You have completed <?php echo e($user->quiz_count_week); ?> tests for this week! <br>
...
//dd($days);
	  ...
	  <?php if( $notifications->count() > 0 ): ?>
			...
			<?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				<a href="<?php echo e($row->url); ?>" target="_blank" title="<?php echo e($row->title); ?>"><?php echo e($row->title); ?></a>&nbsp;|&nbsp;
		...
		<?php endif; ?>
			...
			<div class="col-md-6">
				<div class="white_bgcurve coursesList">
					<h5>Results</h5><a class="moreBtn" href="<?php echo e(URL_STUDENT_EXAM_ATTEMPTS . $user->slug); ?>">more</a>
					...
					<ul class="coursesNames">
						...
						<li>
							<div class="col-md-7 coursesText">
									<?php echo e($mark->quizName->title); ?><p class="greyText"><?php echo e(date('d/m/Y', strtotime($mark->created_at))); ?></p>
								</div>
								<div class="col-md-5 pull-right">
									<div class="progress">
									  <?php
										...
										$percent = 100;
									  ?>
									  <div class="progress-bar <?php echo e($class); ?>" role="progressbar" aria-valuenow="10"
									  aria-valuemin="0" aria-valuemax="100" style="width:<?php echo e($percent); ?>%"><?php echo e($mark->marks_obtained.' / '.$mark->total_marks); ?>
					...
					<div class="white_bgcurve" style="clear:both; ">
						 ...
						 */
						 ...
						 <table class="table ">
							...
							<?php $__empty_1 = true; $__currentLoopData = $live_quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $live_quizze): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
							<tr>
								<td>
									<?php echo e($live_quizze->title); ?>
						...
						?>
						 ...
						 <div class="col-md-3">
							...
							<img src="<?php echo e(PREFIX.$settings->subjectsImagepath.$image); ?>" alt="<?php echo e($subject->subject_title); ?>" width="150">
						 	...
						 	<a href="<?php echo e(URL_STUDENT_EXAMS.$subject->slug . '/subject'); ?>" title="<?php echo e($subject->subject_title); ?>"><?php echo e($subject->subject_title); ?></a>
						 </div>
						 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
						 ...
						 <div class="col-md-3" style="padding-top: 20px;">
							...
							<?php $image = $settings->defaultCategoryImage;
							?>
							<img src="<?php echo e(themes('images/exam3.png')); ?>" alt="Exams" width="150">
							</div>
						 	<a href="<?php echo e(url('multiple-student/exams')); ?>" title="Multiple Subjects">Exams</a>
						 </div>
						 <?php endif; ?>
			...
			<div class="row">
				...
				<div class="white_bgcurve coursesList">
					...
					<div class="white_bgcurve" style="clear:both; ">
						 ...
						 ?>
						 <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_type => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						 <div class="col-md-3">
					 		<a href="<?php echo e(route('student.paid_exams', ['type' => $item_type])); ?>" title="<?php echo e($title); ?>"><?php echo e($title); ?></a>
						 </div>
						 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div>
					</div>
		...
		<div class="rightSideContent">
			<div class="rightSideInnerContent userProfileContent">
				<div class="col-md-12 userProfile text-center">
					...
					<img src="<?php echo e(getProfilePath(Auth::user()->image, 'thumb')); ?>" alt="">
					<dl>
						<dt><?php echo e($user->name); ?></dt>
						<dd><?php echo e($user->student_class->name); ?></dd>
						<?php if(count($user->batches) > 0): ?>
...
?> -->
<?php if(isOnlineclassSubscribed()|| isOnlinestudent() ): ?>
				<div class="col-md-12">
...
//echo '@@:' . date('H:i:s', $newtimestamp_after_mins);
	  $classes = 0;
	  ?>
	  <?php $__empty_1 = true; $__currentLoopData = $onlineclasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
		<?php
// $row->class_time = '20:30:00';
		...
		<h4 class="media-heading">
			...
			<p>Time: <?php echo e($row->class_time); ?></p>
			<?php
...
//var_dump($newtimestamp_before_mins >= $row->class_time);
			?>
			<?php if( $newtimestamp_before_mins >= $row->class_time && $newtimestamp_before_mins <= $row->class_time ): ?>
				<p><a class="btn btn-lg btn-success button" href="/student/onlineclasses/attendence/<?php echo e($row->id); ?>" target="_blank" id="join_button_final_<?php echo e($row->id); ?>">Join Now</a></p>
			<?php elseif( $minutes <= TIMER_ENABLE_BEFORE ): ?>
				<p id="timer_<?php echo e($row->id); ?>"><i class="fa fa-spin fa-refresh" style="color: red;"></i>&nbsp;Starts in: <span id="minutes_<?php echo e($row->id); ?>"><?php echo e($minutes); ?> mins</span></p>
				<p><a class="btn btn-lg btn-success button" href="javascript:void(0);" id="join_button_<?php echo e($row->id); ?>" onclick="alert('Class will start in <?php echo e($minutes); ?> mins')" disabled>Join Now</a></p>
			<?php else: ?>
				<?php /* ?>
				<p><i class="fa fa-clock-o" style="color: green;">&nbsp;Starts: {{date('d/m/Y H:i:s', strtotime(date('Y-m-d') . ' ' . $row->class_time))}}</i></p>
				<?php */ ?>
				<p id="timer_<?php echo e($row->id); ?>"><i class="fa fa-spin fa-refresh" style="color: red;" style="display: none;"></i>&nbsp;Starts in: <span id="minutes_<?php echo e($row->id); ?>"><?php echo e($minutes); ?> mins</span></p>
				<p><a class="btn btn-lg btn-success button" href="javascript:void(0);" id="join_button_<?php echo e($row->id); ?>" onclick="alert('Class will start in <?php echo e($minutes); ?> mins')" disabled>Join Now</a></p>
			<?php endif; ?>

			<?php if($row->lmsseries_id || $row->lmsnotes_id): ?>
			<p>
				<?php if($row->lmsseries_id): ?>
				<a href="<?php echo e(URL_STUDENT_LMS_SERIES_VIEW.$row->lmsseries->slug); ?>" target="_blank">LMS</a>
				<?php endif; ?>
				<?php if($row->lmsnotes_id): ?>
				&nbsp;|&nbsp;<a href="<?php echo e(route('lms.preview_notes', ['slug' => $row->lmsnotes->slug])); ?>" target="_blank">Notes</a>
				<?php endif; ?>
			</p>
			<?php endif; ?>
		</h4>
		<p class="greyText">Faculty: <?php echo e($row->createdby->name); ?></p>
		<?php if($row->subject): ?>
		<p class="greyText">Subject: <?php echo e($row->subject->subject_title); ?></p>
		<?php endif; ?>
		<?php if($row->topic): ?>
		<p class="greyText">Topic: <?php echo e($row->topic); ?></p>
		<?php endif; ?>
		</div>
		</div>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php endif; ?>
	  ...
	  ?>
	  <?php $__empty_1 = true; $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quizz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
		<div class="media">
		<div class="media-left">
		<i class="fa fa-codepen" aria-hidden="true"></i>
		</div>
		...
		<div class="media-body">
		<h3 class="media-heading"><a href="<?php echo e(route('studentlms.subjectitems', ['slug' => $quizz->subject_slug, 'series_slug' => $quizz->slug])); ?>"><?php echo e($quizz->subject_title); ?></a></h3>
		<h4 class="media-heading"><?php echo e($quizz->title); ?></h4>
		<p class="greyText"><?php echo e($quizz->end_date); ?></p>
		</div>
		</div>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
	<?php endif; ?>
...
<script type="text/javascript">
	...
	var counter = 0;
	function timerFunc() {
		<?php $__currentLoopData = $onlineclasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<?php
			$valid_from = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', date('Y-m-d') . ' ' . $row->class_time);
			$minutes = now()->diffInMinutes($valid_from, false);
			$minutes_seconds = $minutes * 60;
			?>
			<?php if( $minutes <= TIMER_ENABLE_BEFORE ): ?>
				var minutes_seconds = '<?php echo e($minutes_seconds); ?>';
				minutes_seconds = minutes_seconds - counter;

				var str = Math.floor(minutes_seconds / 60);
				if ( $('#minutes_<?php echo e($row->id); ?>').length > 0 ) {
					if ( str <= 0 ) {
						$('#join_button_<?php echo e($row->id); ?>').attr('href', '/student/onlineclasses/attendence/<?php echo e($row->id); ?>');
						$('#join_button_<?php echo e($row->id); ?>').attr('target', '_blank');
						$('#join_button_<?php echo e($row->id); ?>').removeAttr('disabled');
						$('#join_button_<?php echo e($row->id); ?>').removeAttr('onclick');
						$('#timer_<?php echo e($row->id); ?>').remove();
					}
					// console.log(str);
					...
					$('#minutes_<?php echo e($row->id); ?>').html(str);
				}
			<?php endif; ?>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		counter++;
