					...
					?>
					 ...
					 <fieldset class="form-group">
						...
						<?php echo e(Form::text('email', $value = null, $attributes = array('class'=>'form-control', 'placeholder' => 'jack@jarvis.com',
					...
					<fieldset class="form-group">
                        <?php echo e(Form::label('login_enabled', getphrase('activate_account'))); ?>
						...
						?>
						<?php echo e(Form::select('login_enabled', $login_enabled, null, ['class'=>'form-control',
					...
					?>
					<input type="hidden" name="login_enabled" id="login_enabled" value="<?php echo e($login_enabled); ?>">
					<?php endif; ?>
                  ...
                  <?php endif; ?>
					...
					<?php if(checkRole(getUserGrade(2))): ?>
					<fieldset class="form-group">
						<?php echo e(Form::label('subjects', getphrase('subjects'))); ?>
						...
						?>
						<?php echo e(Form::select('subjects[]', $subjects, null, ['class'=>'form-control select2', 'name'=>'subjects[]', 'multiple'=>'true', 'id' => 'subjects', 'required' => 'true'])); ?>
					...
					<fieldset class="form-group">
						...
						?>
						<?php echo e(Form::select('faculty_batches[]', $batches, null, ['class'=>'form-control select2', 'name'=>'faculty_batches[]', 'multiple'=>'true', 'id' => 'batches'])); ?>
					...
					<fieldset class="form-group" ng-if="role_id == 5">
                        <?php echo e(Form::label('student_class', getphrase('student_class'))); ?>
						...
						?>
						<?php echo e(Form::select('student_class_id', $classes, $value = null, ['class'=>'form-control',
					...
					<fieldset class="form-group" ng-if="role_id != 5">
						<?php echo e(Form::label('online_url', getphrase('online_url'))); ?>

						<span class="text-red">*</span>
						<?php echo e(Form::text('online_url', $value = null , $attributes = array('class'=>'form-control', 'placeholder' =>
					...
					<fieldset class="form-group" ng-if="role_id != 5">
						<?php echo e(Form::label('white_board_code', getphrase('white_board_code'))); ?>

						<span class="text-red">*</span>
						<?php echo e(Form::textarea('white_board_code', $value = null , $attributes = array('class'=>'form-control', 'placeholder' =>
