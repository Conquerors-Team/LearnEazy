<div class="row">
        <?php echo Form::open(array('url' => url()->current(), 'method' => 'GET',
        'novalidate'=>'','name'=>'formTopics ')); ?>



        <fieldset class="form-group col-lg-3">
        <?php echo e(Form::label('class_title', getphrase('class'))); ?>
        ...
        ?>
        <?php echo e(Form::select('class_title', $student_classes, null, ['class'=>'form-control', 'id'=>'class_title',
        ...
        <fieldset class="form-group col-lg-3">
        <?php echo e(Form::label('faculty_id', getphrase('faculty'))); ?>
        ...
        ?>
        <?php echo e(Form::select('faculty_id', $faculty, null, ['class'=>'form-control', 'id'=>'faculty_id',
            'ng-model'=>'faculty_id',
        ...
        ?>
        <?php echo e(Form::select('subject_id', $subjects, null, ['class'=>'form-control', 'id'=>'subject_id',
            'ng-model'=>'subject_id',
        ...
        <fieldset class="form-group col-lg-3">
        <?php echo e(Form::label('batch_id', getphrase('batch'))); ?>
        ...
        ?>
        <?php echo e(Form::select('batch_id', $batches, null, ['class'=>'form-control', 'id'=>'batch_id',
        	'ng-model'=>'batch_id',
        	'required'=> 'true',
        ...
        <fieldset class="form-group col-lg-3">
        <?php echo e(Form::label('from_date', getphrase('from_date'))); ?>

        <span class="text-red">*</span>
        <?php echo e(Form::text('from_date', null, ['class'=>'form-control datepicker1', 'id'=>'from_date'
        ])); ?>

        </fieldset>

        <fieldset class="form-group col-lg-3">
        <?php echo e(Form::label('to_date', getphrase('to_date'))); ?>

        <span class="text-red">*</span>
        <?php echo e(Form::text('to_date', null, ['class'=>'form-control datepicker1', 'id'=>'to_date'
        ])); ?>
        ...
        <div class="buttons text-center">
        	...
        	>Search</button>&nbsp;
        	<a href="<?php echo e(url()->current()); ?>" class="btn btn-lg btn-error button"
        	>Reset</a>
        </div>
        </fieldset>
        <?php echo Form::close(); ?>
