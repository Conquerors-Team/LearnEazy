					...
					<fieldset class="form-group col-md-6" >
						<?php echo e(Form::label('student_class_id', 'Student class')); ?>


						<?php
						$student_classes = \App\StudentClass::where('institute_id', adminInstituteId())->get()->pluck('name', 'id')->toArray();
						?>
						<?php echo e(Form::select('student_class_id', $student_classes, null, ['placeholder' => getPhrase('select'),'class'=>'form-control',
					...
					<input type="hidden" name="created_by_id" id="created_by_id" value="<?php echo e(\Auth::id()); ?>">
					<?php else: ?>
					<fieldset class="form-group col-md-6" >
						<?php echo e(Form::label('created_by_id', 'Faculty')); ?>
						...
						?>
						<?php echo e(Form::select('created_by_id', $faculty, null, ['placeholder' => getPhrase('select'),'class'=>'form-control',
				...
				<fieldset class="form-group col-md-6">
				<?php echo e(Form::label('url', getphrase('url'))); ?>
				...
				?>
				<?php echo e(Form::text('url', $value = $url, $attributes = array('class'=>'form-control', 'placeholder' => 'www.sitename.com',
				'id' => 'online_url',
					))); ?>
				...
				<fieldset class="form-group col-md-4">
                        <?php echo e(Form::label('class_duration', getphrase('class_duration'))); ?> (In Minutes)
                        <?php echo e(Form::text('class_duration', $value = null, $attributes = array('id' => 'class_duration', 'class'=>'form-control', 'placeholder' => '50'))); ?>
		 	...
		 	if($record)
		 	{
		 	 ...
		 	 ?>
				...
				<fieldset class="form-group col-md-4">
				<?php echo e(Form::label('valid_from', getphrase('valid_from'))); ?>

				<?php echo e(Form::text('valid_from', $value = $date_from , $attributes = array('id' => 'valid_from', 'class'=>'input-sm form-control', 'placeholder' => '2015/7/17'))); ?>
  				 ...
  				 <fieldset class="form-group col-md-4">
                        <?php echo e(Form::label('valid_to', getphrase('valid_to'))); ?>

                        <?php echo e(Form::text('valid_to', $value = $date_to , $attributes = array('id' => 'valid_to', 'class'=>'input-sm form-control', 'placeholder' => '2015/7/17 15:10:2'))); ?>
	    		...
	    		<fieldset class="form-group col-md-4">
						<?php echo e(Form::label('class_time', getphrase('class_time'))); ?>

						<?php echo e(Form::select('class_time', $slots_times, $value = null, ['class'=>'form-control','placeholder'=>'select',
						    'ng-model'=>'class_time',
                            'required'=> 'true',
					...
					<fieldset class="form-group  col-md-6">
						...
						<?php echo e(Form::textarea('short_description', $value = null , $attributes = array('class'=>'form-control', 'rows'=>'5', 'placeholder' => getPhrase('short_description')))); ?>
					...
					<fieldset class="form-group  col-md-6">
						...
						<div class="buttons text-center">
							...
							ng-disabled='!formNotifications.$valid'><?php echo e($button_name); ?></button>
