...
<!-- banner part start-->
    <section class="banner_part_inst">
        <div class="container my-lg-5 py-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
          <img src="<?php echo e(themes('site/img/institute.png')); ?>" class="img-fluid">
        </div>
               ...
               <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon bg-orange"><img src="<?php echo e(themes('site/img/1.png')); ?>" class="ani-img"></span>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon bg-orange"><img src="<?php echo e(themes('site/img/2.png')); ?>" class="ani-img"></span>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon bg-orange"><img src="<?php echo e(themes('site/img/3.png')); ?>" class="ani-img"></span>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            <span class="single_feature_icon bg-orange"><img src="<?php echo e(themes('site/img/4.png')); ?>" class="ani-img"></span>
        ...
        <div class="container">
            <div class="row align-items-sm-center align-items-xl-stretch" style="margin-bottom: 130px;">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="<?php echo e(themes('site/img/live-classes.png')); ?>" alt="" style="height:350px; float: right;">
                    </div>
                </div>
            </div>
           <div class="clearfix"></div>
             <div class="row align-items-sm-center align-items-xl-stretch" style="margin-bottom: 130px;">
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="<?php echo e(themes('site/img/quality-content.png')); ?>" alt="" style="height: 300px; float: left;">
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="learning_member_text">
            ...
            <div class="row align-items-sm-center align-items-xl-stretch" style="margin-bottom: 130px;">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="<?php echo e(themes('site/img/live-quiz.png')); ?>" alt="" style="height: 300px; float: right;">
                    </div>
                </div>
            </div>
           <div class="clearfix"></div>
             <div class="row align-items-sm-center align-items-xl-stretch" style="margin-bottom: 130px;">
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="<?php echo e(themes('site/img/exam-portal.png')); ?>" alt="" style="height: 300px; float: left;">
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="learning_member_text">
            ...
            <div class="row align-items-sm-center align-items-xl-stretch">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="<?php echo e(themes('site/img/reports.png')); ?>" alt="" style="height: 300px; float: right;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="special_cource padding_top text-center" style="margin-bottom: 30px">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <img alt="" src="<?php echo e(themes('site/img/attendance.png')); ?>">
            <dl>
          ...
          <div class="col-md-3">
            <img alt="" src="<?php echo e(themes('site/img/from-series.png')); ?>">
            <dl>
          ...
          <div class="col-md-3">
            <img alt="" src="<?php echo e(themes('site/img/online-course.png')); ?>">
            <dl>
          ...
          <div class="col-md-3">
            <img alt="" src="<?php echo e(themes('site/img/class-management.png')); ?>">
            <dl>
