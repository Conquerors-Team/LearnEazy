...
class InstructionsController extends Controller
{
    ...
    public function index()
    {
      ...
      if(!canDo('exam_instruction_access'))
      {
    ...
    public function getDatatable($slug = '')
    {
      ...
      $institute_id   = adminInstituteId();
        ...
        $records = Instruction::select(['institute_id', 'title', 'content', 'id', 'slug','updated_at'])
        ...
        $temp.= '<li><a href="'.URL_INSTRUCTIONS_EDIT.$records->slug.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a></li>';
    ...
    {
      if(!canDo('exam_instruction_create'))
      {
        prepareBlockUserMessage();
        return back();
      }
    ...
    {
      if(!canDo( 'exam_instruction_edit'))
      {
        prepareBlockUserMessage();
        return back();
      }
    ...
    {
      if(!canDo( 'exam_instruction_delete'))
      {
        prepareBlockUserMessage();
        return back();
      }
