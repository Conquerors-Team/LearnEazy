    ...
    public function getDatatable()
    {
      ...
      $institute_id   = adminInstituteId();
         ...
         if(checkRole(getUserGrade(3))){
            ...
            $records = LmsCategory::select(['institute_id','category', 'image', 'description', 'id','slug']);
            ...
            if(shareData()){
                ...
                $records = LmsCategory::select(['category', 'image', 'description', 'id','slug'])
        ...
        if(checkRole(getUserGrade(2))) {
          ...
          if($records->institute_id  == $institute_id || checkRole(getUserGrade(2))){
            ...
            $temp.= '<li><a href="'.URL_LMS_CATEGORIES_EDIT.$records->slug.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a></li>';
          }
