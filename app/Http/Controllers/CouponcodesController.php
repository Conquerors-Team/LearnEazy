...
class CouponcodesController extends Controller
{
      ...
      if(!canDo('coupon_access'))
      {
        ...
        $records = array();
         ...
         if(checkRole(getUserGrade(3))){
               ...
               $records = Couponcode::select(['institute_id','title', 'coupon_code', 'discount_type', 'discount_value', 'minimum_bill','discount_maximum_amount','usage_limit', 'status', 'id','slug' ]);
         }
         else{
        ...
        if(checkRole(getUserGrade(2))) {
          ...
          if($records->institute_id  == $institute_id || checkRole(getUserGrade(2))){
            ...
            $temp.= '<li><a href="'.URL_COUPONS_EDIT.$records->slug.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a></li>';
          }
        ...
        ->removeColumn('slug')
        ->removeColumn('tags')
        ->rawColumns(['institute_id','usage_limit','status','action'])
    ...
    public function create()
    {
      if(!canDo('coupon_create'))
      {
        ...
        $data['categories']           =array(
            ...
            'lms'=> getPhrase('LMS'),
            'institute_package' => 'Institute Packages',
            'student_package' => 'Student Packages',
        );
    ...
    public function validateCoupon(Request $request)
    {
    	...
    	if($item_type=='combo')
    	{
            ...
            $item_type = 'institute_package';
            $item = \App\Package::where('slug', '=', $request->item_name)->first();
        }
        else if($item_type=='paidcontent'){
            // $item_type = 'paidcontent';
            $item = \App\StudentPaidContent::where('slug', '=', $request->item_name)->first();
        }
