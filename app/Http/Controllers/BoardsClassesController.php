...
class BoardsClassesController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['title']              = getPhrase('board_class');
        $data['layout']     = getLayout();

         $view_name = getTheme().'::exams.boards.board-classes.list';
    ...
    public function getDatatable()
    {
        ...
        if(checkRole(getUserGrade(3))) {
            ...
            $records = BoardClass::select([ 'title', 'status', 'id']);
        ...
        if(checkRole(getUserGrade(2))) {
          ...
          if($records->institute_id  == $institute_id || checkRole(getUserGrade(2))){
            ...
            $temp.= '<li><a href="'.URL_BOARD_CLASSES_EDIT.'/'.$records->id.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a></li>';
          }
    ...
    public function create()
    {
        ...
        $data['record']             = FALSE;
        $data['active_class']       = 'syllabus_contents';
        $data['title']              = getPhrase('create_board_class');
        $data['layout']     = getLayout();

           $view_name = getTheme().'::exams.boards.board-classes.add-edit';
        return view($view_name, $data);
    }
    ...
    public function edit($id)
    {
        ...
        $record = BoardClass::where('id',$id)->first();
        ...
        $data['record']             = $record;
        $data['active_class']       = 'syllabus_contents';
        $data['title']              = getPhrase('edit_board_class');
        $data['layout']     = getLayout();
    ...
    public function update(Request $request, $id)
    {
       ...
       $this->validate($request, $rules);
        ...
        return redirect(URL_BOARDS_CLASSES);
    }
