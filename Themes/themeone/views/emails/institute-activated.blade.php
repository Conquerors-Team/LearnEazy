@include('emails.template_header')
   ...
   <div class="row">
	...
	<p style="font-size:20px;margin:11px 0;">Your institute {{$ins_name}} was {{$status_message}}. You can now login to the website with the login credentials that were sent during the registration.</p>

<!-- <p style="font-size:20px;margin:11px 0;">Admin Comments</p>
<p style="font-size:20px;margin:11px 0;">{{$comments}}</p> -->
