	...
	<div id="wrapper" class="{{$class}}">
		...
		<?php } ?>
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" target="_blank" href="{{URL_HOME}}"><img src="{{IMAGE_PATH_SETTINGS.getSetting('site_logo', 'site_settings')}}" alt="{{getSetting('site_title','site_settings')}}"></a>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav side-nav {{$block_class}}">
					...
					<li {{ isActive($active_class, 'subjects') }}>
						<a href="{{URL_STUDENT_SUBJECTS}}">
							<i class="icon-books"></i>&nbsp;&nbsp;&nbsp;&nbsp;{{ getPhrase('subjects') }}
						</a>
					</li>
					--}}
					...
					<ul id="exams" class="collapse sidemenu-dropdown">
						<li><a href="{{URL_STUDENT_EXAM_SUBJECTS}}"> <i class="fa fa-random"></i>{{ getPhrase('subjects') }}</a></li>
					</ul>
					</li>
					--}}
...
<a  href="{{URL_MESSAGES}}"> <i class="fa fa-fw fa-comments" aria-hidden="true"> </i>
					...
					<li {{ isActive($active_class, 'onlineclasses') }} >
						<a href="{{URL_ONLINECLASSES}}" ><i class="fa fa-cloud" aria-hidden="true"></i>
					...
					<li {{ isActive($active_class, 'paid_content') }} >
					<a  href="{{route('student.paid_content')}}"><i class="fa fa-fw fa-ticket" ></i>
					{{ getPhrase('buy_now') }} </a>
					</li>
					@endif
