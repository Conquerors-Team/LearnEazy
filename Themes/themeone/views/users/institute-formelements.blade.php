            ...
            <fieldset class='form-group' ng-if="role_id == 5">
                ...
                <label for="exampleInputEmail1">{{getPhrase('student_assigning_to')}}</label>
                <span class="text-red">*</span>
                <div class="form-group row">
                    <div class="col-md-6">
                        <input type="radio" checked="checked" id="available" name="is_main" value="1" ng-model="account_available" ng-init="account_available=1; accountAvailable(1);" ng-click="accountAvailable(1)">
                        <label for="available"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> 
                        </span> {{ $institute->institute_name }} </label>
                    </div>
                    <div class="col-md-6">
                        <input type="radio" id="not_available" name="is_main" value="0" ng-model="account_not_available" ng-click="accountAvailable(0)">
                        <label for="not_available"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i>
                         </span> {{getPhrase('other_branches')}} </label>
                    </div>
                </div>
        	 ...
        	 <fieldset class="form-group" ng-if="role_id == 8">
						...
						{{Form::select('branch_id', $branches, null, ['placeholder' => getPhrase('select_branch'),
							...
							'ng-class'=>'{"has-error": formUsers.branch_id.$touched && formUsers.branch_id.$invalid}'

						 ])}}

						  <div class="validation-error" ng-messages="formUsers.branch_id.$error" >
					 ...
					 <fieldset class="form-group" ng-if="userDetails">
