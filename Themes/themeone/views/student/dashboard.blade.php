					...
					<div class="layer2">
									...
									<ul class="coursesNames">
										...
										<li>
											<div class="col-md-7 coursesText">
												{{$mark->quizName->title}}
												<p class="greyText">{{date('d/m/Y', strtotime($mark->created_at))}}</p>
											</div>
						 ...
						 */
									...
									<table class="table ">
										...
										<tr>
											...
											<td>
												...
												if (count($quiz->subjects) > 0) {
													echo $subjects = '<p><span class="label label-info label-many">' . implode(
														'</span><span class="label label-info label-many"> ',
														$quiz->subjects->pluck('subject_title')->toArray()
													) . '</span></p>';
												}
												?>
											</td>
										...
										@empty
										<tr>
											<td colspan="3" align="center">No Liquizzes today!</td>
										</tr>
										@endforelse
									</table>
								</div>
