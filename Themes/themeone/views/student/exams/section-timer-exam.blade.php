...
@if( ! empty( $lms_slug ) )
  <div class="col-md-6">
  @include('student.exams.exam-leftbar-lmscontent', array('lms_slug' => $lms_slug))
  </div>
  <div class="col-md-6">
@else
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-heading">
                        ...
                        <?php
                           ...
                           ?>
                          <div id="timerdiv1" class="countdown-styled ">
                            <span id="hours1">{{ $data['time_hours']}}</span> :
                            <span id="mins1">{{ $data['time_minutes']}}</span> :
