...
// console.log(data);
    ...
    $scope.getContents = function() {
        route = '{{route("paid_content.lmsseries")}}';
        data= {
                _method: 'post',
                ...
                'question_bank_type_id': $scope.question_bank_type_id,
                'questionbank_category_id': $scope.questionbank_category_id
            };
    ...
    $scope.getChaptersTopics = function(){
        ...
        route = '{{url("mastersettings/topics/get-parents-topics")}}/' + $scope.subject_id + '/' + $scope.chapter_id;
        data= {_method: 'get', '_token':httpPreConfig.getToken()};
            httpPreConfig.webServiceCallPost(route, data).then(function(result){
...
/*
var items = [];
function getSubjectChapters1( categoryItems )
{
  items = categoryItems;
  console.log(items)
...
function getChaptersTopics()
{
  ...
  route = '{{url("mastersettings/topics/get-parents-topics")}}/'+subject_id + '/' + chapter_id;
  var token = $('[name="_token"]').val();
