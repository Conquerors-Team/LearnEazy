				...
				<div class="panel panel-custom" ng-init="initAngData({{$settings}});" >
					...
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
				            ...
				            <a href="{{URL_LMS_CONTENT_ADD}}" class="btn  btn-primary button" >{{ getPhrase('create lms content')}}</a>
				            @endif 
					...
					<?php $button_name = getPhrase('create'); ?>
							...
							?>
							{{Form::select('questionbank_category_id', $categries, null, ['class'=>'form-control', "id"=>"questionbank_category_id", 'ng-model' => 'questionbank_category_id'])}}
							</fieldset>
