...
<fieldset class="form-group">
	{{ Form::label('lmsseries', getphrase('lmsseries')) }}
	<span class="text-red">*</span>
	{{Form::select('lmsseries[]', $lmsseries, null, ['class'=>'form-control select2', 'name'=>'lmsseries[]', 'id' => 'lmsseries', 'required' => 'true', 'multiple'=>'true',])}}
</fieldset>
...
<script>
    ...
    $('#class').change(function() {
    	window.location = '{{route("studentpaidcontent.series", $record->id)}}/' + $(this).val();
    });
