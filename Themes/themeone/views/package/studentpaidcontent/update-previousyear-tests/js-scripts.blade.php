...
// console.log(data);
    ...
    $scope.competitiveExamTypeChanged = function(competitive_type) {
      // console.log(selected_number)
        if(competitive_type=='')
            competitive_type = $scope.chapter_id;
        chapter_id = competitive_type;
    ...
    $scope.getContents = function() {
        route = '{{route("paid_content.previousyear-tests")}}';
        data= {
                _method: 'post',
