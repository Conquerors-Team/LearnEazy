...
<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							@if(checkRole(getUserGrade(2), 'chapter_access'))
				...
				<!-- /.row -->
					...
					<a href="{{DOWNLOAD_LINK_CHAPTERS_IMPORT_EXCEL}}" class="btn btn-info">{{getPhrase('download_template')}}
					</a>

					<?php $button_name = getPhrase('upload'); ?>
						{!! Form::open(array('url' => URL_CHAPTERS_IMPORT, 'method' => 'POST', 'novalidate'=>'','name'=>'formUsers ', 'files'=>'true')) !!}
