<div ng-if="question_type=='checkbox'">
    ...
    <fieldset class="form-group col-md-4" >
     ...
     <fieldset class="form-group col-md-4" >
        ...
        <input type="text" name="optionsl2[]" id="optionl2_@{{ $index }}" class="form-control" placeholder="Option 2nd lang @{{ $index+1 }}" ng-model="answers[$index].optionl2_value" ckeditor>
